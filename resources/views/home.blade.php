...
<html lang="en" class="no-js">
	<head>
		...
		<!--website-favicon-->
		<link href="http://2.bp.blogspot.com/-GUko8t7XodU/VND4AhaJj4I/AAAAAAAABhI/cOZOsW0zdHM/s1600/logo+pemkab+penajam+paser+utara.png" rel="icon">
		<!--plugin-css-->
			...
			<section class="hero-section hero-creative-agenc2" id="home">
						...
						<div class="row">
							...
							<div class="col-lg-6 v-center">
								<div class="img-design h-scl-">
									<div class="imgac "> <img src="{{asset('images/1.png')}}" alt="creative agnecy html template" class="ag-dg1 img-fluid h-scl-base"></div>
									<div class="imgac h-scl-base"><img src="{{asset('images/2.png')}}" alt="creative agnecy html template" class="ag-dg2 img-fluid "></div>
						...
						<div class="row upset ovr-bg2 bd-hor">
							...
							<div class="-cta-btn mt70">
								<div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1s">
									...
									<a href="#" class="btn-main bg-btn7 lnk"> Request a proposal<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="dg-portfolio-section pb80 pt80" id="work">
					...
					<div class="photosets- pb80 pt50">
						<div class="container">
							<div class="row">
								<div class="col-lg-5 mt30 h-scl-"><div class="img-ca2set h-scl-base"><img src="images/about/office-1.jpg" alt="companyname" class="img-fluid"></div> </div>
								<div class="col-lg-7 mt30 h-scl-"><div class="img-ca2set h-scl-base"><img src="images/about/office-2.jpg" alt="companyname" class="img-fluid"></div> </div>
								<div class="col-lg-7 mt30 h-scl-"><div class="img-ca2set h-scl-base"><img src="images/about/office-3.jpg" alt="companyname" class="img-fluid"></div> </div>
								<div class="col-lg-5 mt30 h-scl-"><div class="img-ca2set h-scl-base"><img src="images/about/office-4.jpg" alt="companyname" class="img-fluid"></div> </div>
							</div>
						</div>
					</div>
					<!--End photo gallery-->
								...
								<div class="col-lg-5 v-center">
									<div class="email-subs-form">
										<div class="form-cta">
											...
											<button type="submit" name="submit" class="lnk btn-main bg-btn7">Subscribe <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></button>
										</div>
									</div>
								</div>
							</div>
