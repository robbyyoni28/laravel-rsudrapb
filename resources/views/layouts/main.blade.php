...
<html lang="en" class="no-js">
  <head>
    ...
    <!--website-favicon-->
    <link href="{{asset('images/logo_penajam.png')}}" rel="icon">
    <!--plugin-css-->
				   ...
				   <div class="custom-nav" role="navigation">
					  <ul class="nav-list">
						 ...
						 <li class="sbmenu rpdropdown">
							<a href="#" class="menu-links">Fasilitas dan layanan</a>
								  ...
								  <div class="sub-menu-center-block">
									 <div class="sub-menu-column smfull">
										<ul>
										   ...
										   <li><a href="portfolio-details.html">Jadwal Dokter</a> </li>
										   <li><a href="portfolio-details.html">Layanan Unggulan</a> </li>
										</ul>
									 </div>
								  </div>
							   </div>
						 ...
						 <li class="sbmenu rpdropdown">
							<a href="#" class="menu-links">Penghargaan</a>
							<div class="nx-dropdown menu-dorpdown">
							   <div class="sub-menu-section">
								  <div class="sub-menu-center-block">
									 <div class="sub-menu-column smfull">
